...
impl CubemapLoader {
    ...
    pub fn load_from_fs_hdr(
        ...
        unsafe {
            ...
            let cubemap = Cubemap::from_id(
                ...
                Dimensions::Cubemap { dimension: 128 },
            );
    ...
    pub fn load_from_fs_mipmaps(directory: PathBuf, extension: &str, mipmaps: u32, facade: &impl Facade) -> CubemapType {
        let cubemap_id = Self::load_cubemap_gl(Self::create_paths(directory, extension));
        ...
        unsafe {
            let cubemap = Cubemap::from_id(
                ...
                cubemap_id,
                true,
                MipmapsOption::AutoGeneratedMipmapsMax(mipmaps),
                Dimensions::Cubemap { dimension: 2u32.pow(mipmaps) },
            );
